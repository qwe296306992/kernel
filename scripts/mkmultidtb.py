...
DTBS['RK3568-ATK-EVB1'] = OrderedDict([('rk3568-atk-atompi-ca1-720p', '#_saradc_ch1=0#_saradc_ch2=0'),
                                       ('rk3568-atk-atompi-ca1-1080p', '#_saradc_ch1=0#_saradc_ch2=341'),
                                       ('rk3568-atk-atompi-ca1-10p1_800x1280', '#_saradc_ch1=0#_saradc_ch2=702'),
                                       ('rk3568-atk-atompi-ca1', '#_saradc_ch1=0'),
                                       ('rk3568-atk-evb1-mipi-dsi-720p', '#_saradc_ch2=0'),
                                       ('rk3568-atk-evb1-mipi-dsi-1080p', '#_saradc_ch2=341'),
                                       ('rk3568-atk-evb1-mipi-dsi-10p1_800x1280', '#_saradc_ch2=702')])
